        ...
        const analyze = async () => {
            ...
            try {
                ...
                const gaze = {
                    ...
                    leftGazeX: iris.left?.gazeX ?? null,
                    leftGazeY: iris.left?.gazeY ?? null,
                    rightGazeX: iris.right?.gazeX ?? null,
                    rightGazeY: iris.right?.gazeY ?? null,
                    ...
                    fused: fusedGaze.fused,
                    geometric: fusedGaze.geometric,
                    appearanceWeight: fusedGaze.appearanceWeight,
                    l2csAgeMs,
                    head: face?.headPose ?? null,
